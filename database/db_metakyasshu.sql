...
(
    ...
    index idx_pkCollaborator (pkCollaborator),
    index idx_fkUserCollaborator (fkUserCollaborator),
...
(
    ...
    constraint fk_collaborator_invitation foreign key (fkCollaborator)
        references tbl_collaborator (pkCollaborator),
    constraint uk_fkCollaborator unique (fkCollaborator),

    index idx_pkInvitation (pkInvitation),
    index idx_codeInvitation (codeInvitation),
    index idx_fkCollaborator (fkCollaborator)
);
...
(
    ...
    constraint fk_user_balance foreign key (fkUser)
        references tbl_user (pkUser),
    constraint fk_category_balance foreign key (fkCategory)
        references tbl_category (pkCategory),
